    ...
    <div class="seccion areas">
        <ul class="contenedor-areas">
            <li class="area">
                ...
                ?>
                <img src="<?php echo esc_attr($imagen); // Escapar el atributo por seguridad ?>" alt="">
                <p><?php echo esc_attr($area1['area_texto']); ?></p>
            </li>
            <li class="area">
                <?php
                ...
                ?>
                <img src="<?php echo esc_attr($imagen); // Escapar el atributo por seguridad ?>" alt="">
                <p><?php echo esc_attr($area2['area_texto']); ?></p>
            </li>
            <li class="area">
                <?php
                ...
                ?>
                <img src="<?php echo esc_attr($imagen); // Escapar el atributo por seguridad ?>" alt="">
                <p><?php echo esc_attr($area3['area_texto']); ?></p>
            </li>
            <li class="area">
                <?php
                ...
                ?>
                <img src="<?php echo esc_attr($imagen); // Escapar el atributo por seguridad ?>" alt="">
                <p><?php echo esc_attr($area4['area_texto']); ?></p>
            </li>
        </ul>
    </div>
        ...
        <div class="contenedor-testimoniales">
            <ul class="listado-testimoniales">
                <?php
                    ...
                    $testimoniales = new WP_Query($args); // Al tiro con el new, es un objetoooo
