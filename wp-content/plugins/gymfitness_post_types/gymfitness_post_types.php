...
// El archivo se recomienda que se llame como el plugin, como la carpeta

if(!defined('ABSPATH')) die(); // Para que no se pueda abrir en un navegador y visualizar el contenido
...
function gymfitness_clases_post_type() {
	...
	$args = array(
		...
		'hierarchical'          => true, // true = posts false = páginas, a los posts no les puedes generar un elemento padre, las páginas sí
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
        'menu_position'         => 6,
